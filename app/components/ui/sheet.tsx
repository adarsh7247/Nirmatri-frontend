...
/* =========================================================
   ✅ MAIN FIX IS HERE (AUTO SheetTitle)
   ========================================================= */
  ...
  return (
    <SheetPortal>
      ...
      >
        ...
        <SheetPrimitive.Close className="absolute right-4 top-4 opacity-70 transition hover:opacity-100">
...
/* Optional: still exposed if you want visible titles */
function SheetTitle(
